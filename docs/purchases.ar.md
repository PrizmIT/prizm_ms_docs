...
تدير وحدة فواتير الموردين تسجيل واعتماد وتتبع دفع الفواتير الواردة من الموردين. ترتبط مباشرة بأوامر الشراء والموردين والمشاريع ومدير الموارد لضمان التتبع الكامل.

للاطلاع على التوثيق الكامل، راجع **[دليل مستخدم فواتير الموردين](supplier-invoice.md)**.

### المزايا الرئيسية

- تسجيل الفواتير يدوياً أو من أوامر الشراء (مع ملء البنود تلقائياً)
- ربط بنود الفاتورة بمدير الموارد مع تتبع حالة الربط
- سير عمل موافقات متعدد المراحل قابل للتهيئة
- تتبع حالة الدفع (غير مدفوعة ← مدفوعة) مع إمكانية التراجع عن الدفع
- مرفقات الملفات وسجل نشاط كامل للتدقيق
